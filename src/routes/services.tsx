      ...
      <section className="relative overflow-hidden border-b border-border">
        ...
        <div className="relative container mx-auto px-6 py-28 max-w-5xl">
          <Reveal>
            ...
            <p className="text-xs tracking-[0.3em] text-accent mb-3 text-slate-50">From close protection to full-site security operations, every service is delivered with the highest standards of confidentiality, vigilance, and customer care.</p>
          </Reveal>
        </div>
      </section>
